...
describe('PerformanceCard', () => {
  ...
  describe('Benchmark Bar Rendering - Bug Fixes', () => {
    it('should render S&P 500 bar in correct section when portfolio positive and S&P 500 negative', () => {
      ...
      usePortfolioOverview.mockReturnValue({
      ...
      const positiveSection = container.querySelector('.flex-1.relative.flex.justify-around.items-end');
      ...
      const negativeSection = container.querySelector('.flex-1.relative.flex.justify-around.items-start');
