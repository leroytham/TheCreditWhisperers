 ...
 *
 * Displays 4 key sentiment metrics in a responsive grid:
 * 1. Overall Sentiment - Primary sentiment classification
 * 2. Momentum - 7-day trend percentage
 * 3. Distribution - 5-category breakdown (Bullish, Somewhat-Bullish, Neutral, Somewhat-Bearish, Bearish)
 * 4. Volatility - Sentiment stability score
 *
 * @param {Object} props
            ...
            <div className="relative">
              ...
              {showTooltip === 'volatility' && (
                <div className="absolute right-0 top-6 w-72 bg-gray-900 text-white text-xs rounded-lg shadow-lg p-3 z-50">
                  ...
                  <p className="mb-2">Measures how much sentiment fluctuates over time.</p>
                  <div className="bg-gray-800 p-2 rounded mb-2 font-mono text-[10px]">
                  ...
                  <p className="text-gray-300">Higher score = more unstable sentiment. Low (&lt;3), Medium (3-6), High (&gt;6).</p>
                </div>
              )}
            </div>
          </div>
