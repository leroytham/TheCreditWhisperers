// frontend/src/features/shared/components/NewsError.tsx
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-12 px-4 bg-red-50 border border-red-200 rounded-lg">
      ...
      <p className="text-sm text-red-700 max-w-sm mb-6">
        {typeof error === 'string' ? error : error?.message || 'An unexpected error occurred. Please check your connection and try again.'}
      </p>
      {onRetry && (
        <button
          onClick={onRetry}
