...
import type { NotificationCategory, PriorityLevel } from '../../../types';
...
export const useNotificationMutation = (mutationFn: (variables: any) => Promise<any>, options: NotificationMutationOptions = {}) => {
